...
% and NS2 of participants, across the three trials of collaborative
% assembly with iCub.
%
...
for i=1:3
    ...
    %%% Left
    neg_sub=load(strcat('Data/extraction/leftArmEndEffector/negativeAtt/NS2/manip',num2str(i),'_neg_subjects_good'));
    ...
    %%% Right
    neg_sub=load(strcat('Data/extraction/rightArmEndEffector/negativeAtt/NS2/manip',num2str(i),'_neg_subjects_good'));
    N_neg_sub=length(neg_sub);
...
for i=1:3
    ...
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_leftArm_trial_forceMax.png');
    ...
    title(strcat('Trial  ',num2str(i)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_leftArm_trial_forceMedian.png');
    ...
    title(strcat('Trial  ',num2str(i)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_leftArm_trial_forceMean.png');
    ...
    ylabel('Fmax per subject')
    title(strcat('Trial  ',num2str(i)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_rightArm_trial_forceMax.png');
    ...
    ylabel('Fmedian per subject')
    title(strcat('Trial  ',num2str(i)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_rightArm_trial_forceMedian.png');
    ...
    ylabel('Fmean per subject')
    title(strcat('Trial  ',num2str(i)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_rightArm_trial_forceMean.png');
...
for cat=1:3
    ...
    xlabel('Trial')
    ylabel('Fmax per subject')
    title(strcat('NS2-',num2str(cat)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_leftArm_cat_forceMax.png');
    ...
    ylabel('Fmedian per subject')
    title(strcat('NS2-',num2str(cat)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_leftArm_cat_forceMedian.png');
    ...
    ylabel('Fmean per subject')
    title(strcat('NS2-',num2str(cat)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_leftArm_cat_forceMean.png');
    ...
    ylabel('Fmax per subject')
    title(strcat('NS2-',num2str(cat)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_rightArm_cat_forceMax.png');
    ...
    ylabel('Fmedian per subject')
    title(strcat('NS2-',num2str(cat)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_rightArm_cat_forceMedian.png');
    ...
    ylabel('Fmean per subject')
    title(strcat('NS2-',num2str(cat)))
    saveas(gcf,'Data/results/boxplot/negativeAtt/NS2_rightArm_cat_forceMean.png');
