...
if flag_left_arm ==1
    ...
    for i=1:3 % Manipulation
        ...
        % Arm End Effector
        good_sub=load(strcat('Data/extraction/leftArmEndEffector/negativeAtt/NS2/manip',num2str(i),'_neg_subjects_good'));
    ...
    saveas(gcf,strcat('Data/results/leftArm_correlation_NS2_force.png'));
