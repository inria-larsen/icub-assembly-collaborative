...
if flag_left_arm ==1
    ...
    for i=1:3 % Manipulation
        ...
        % Skin pressure
        good_sub=load(strcat('Data/extraction/leftSkinForearm/negativeAtt/NS2/manip',num2str(i),'_neg_subjects_good'));
        ...
        % Graphics with fit curves
            ...
            xlabel('NS2','FontSize',plot_fontsize,'Position',[plot_xabs_x plot_xabs_y])
    ...
    saveas(gcf,strcat('Data/results/leftArm_correlation_NS2_pressureSkin.png'));
