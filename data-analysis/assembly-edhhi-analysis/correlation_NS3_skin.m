...
if flag_left_arm ==1
    ...
    for i=1:3 % Manipulation
        ...
        % Sensors number
        good_sub=load(strcat('Data/extraction/leftSkinForearm/negativeAtt/NS3/manip',num2str(i),'_neg_subjects_good'));
        correlation_numMax=[];
        correlation_numMean=[];
        ...
        % Graphics with fit curves
            ...
            xlabel('NS3','FontSize',plot_fontsize,'Position',[plot_xabs_x plot_xabs_y])
    ...
    saveas(gcf,strcat('Data/results/leftArm_correlation_NS3_numSkin.png'));
...
if flag_right_arm ==1
    ...
    for i=2:3 % Manipulation
        ...
        for sub=1:size(good_sub)
            ...
            mat=[];
            mat=load(Forcestrcat('Data/extraction/rightSkinForearm/',num2str(good_sub(sub,1)),'/num_active_sensors_manip',num2str(i)));
            % Force max
            max_mat=max(mat);
            correlation_numMax=[correlation_numMax; good_sub(sub,2) max_mat];
            % Force mean
