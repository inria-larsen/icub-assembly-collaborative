...
if flag_left_arm ==1
    ...
    for i=1:3 % Manipulation
        ...
        % Graphics with fit curves
            ...
            xlabel('NARS','FontSize',plot_fontsize,'HorizontalAlignment','right')
            ylabel('Fmax','FontSize',plot_fontsize)
            ...
            text('String',textcorr,'FontSize',plot_fontsize_corr,'Parent',curPlot,'Position',[60 -5]);                        
            ...
            xlabel('NARS','FontSize',plot_fontsize)
            ylabel('Fmean','FontSize',plot_fontsize)
            axis([xmin xmax ymin ymax])
            
            textPearson=strcat('Pearson: r= ',num2str(correl),' p= ',num2str(pval));                   
            textSpearman=strcat('Spearman: rho= ',num2str(rho),' p= ',num2str(pvalrho));           
            textcorr=sprintf('%s \n%s',textPearson,textSpearman);
            text('String',textcorr,'FontSize',plot_fontsize_corr,'Parent',curPlot,'HorizontalAlignment','center','VerticalAlignment','top');                        
            ...
            xlabel('NARS','FontSize',plot_fontsize)
            ylabel('Fmedian','FontSize',plot_fontsize)
            axis([xmin xmax ymin ymax])
    ...
    %saveas(gcf,strcat('Data/results/leftArm_correlation_nars_force_basic.png'));
