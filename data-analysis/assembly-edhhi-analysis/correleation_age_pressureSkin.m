...
if flag_left_arm ==1
    ...
    for i=1:3 % Manipulation
        ...
        % Skin pressure
        good_sub=load(strcat('Data/extraction/leftSkinForearm/age/manip',num2str(i),'_age_subjects_good'));
        ...
        % Graphics with fit curves
            ...
            xlabel('Age','FontSize',plot_fontsize,'Position',[plot_xabs_x plot_xabs_y])
    ...
    saveas(gcf,strcat('Data/results/leftArm_correlation_age_pressureSkin.png'));
